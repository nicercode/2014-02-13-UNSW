...
**Materials**: If you have not already done so, please [download the lesson materials for this bootcamp](https://github.com/nicercode/2014-02-13-UNSW/raw/gh-pages/data/lessons.zip), unzip, then go to the directory `reproducible`, and open (double click) on the file `reproducible.Rproj` to open Rstudio.
...
[id5]: https://raw.github.com/nicercode/2014-02-13-UNSW/gh-pages/lessons/90-reproducible.zip "UNSW/UTS example of original Rmd file used to generate knitr reports"
