...
**Materials**: If you have not already done so, please [download the lesson materials for this bootcamp](https://github.com/nicercode/2014-02-13-UNSW/raw/gh-pages/data/lessons.zip), unzip, then go to the directory `testing`, and open (double click) on the file `testing.Rproj` to open Rstudio.
